...
public class FindWorkParser implements FindWorkParserService {
	 ...
	 * 
	 * @param cities lista di oggetti di tipo citt&aacute; dove sono presenti i
	 *               lavori che soddisfano le richieste dell'utente.
	 ...
	 * 
	 * @param cities lista di oggetti di tipo citt&aacute; dove sono salvate le
	 *               statistiche di ogni citt&aacute;.
	 * @return <code>Object</code>
	 */
